...
In FSE, the plane carries 9 paseengers and can be had for v$450,000. The monthly cost is ~v$3,000.
...
The inclusion of the G-21 in MSFS 2024 is a delightful inclusion. It's flying from a previous era, and without modern conviences like autopilot or even a wing leveller!

Overall, the plane seems to fly well, if requiring full manual control.

The included model has quite a bit smaller tanks than the FSE configuration (110 gal vs 170 gal per side), and so I [created a variant](#download) to match FSE. The Turbo Goose FSE model has even bigger feul tanks (211 gal per side), amd so while the variant includes big enough tanks to technically accept a full fuel load, it puts the plane over the Maximum Takeoff Weight.
